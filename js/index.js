...
(function () {
    ...
    var option = {
        ...
        xAxis: [
            {
                type: 'category',
                data: ['旅游行业', '教育行业', '游戏行业', '医疗行业', '电商行业', '社交行业'],
                axisTick: {
                    alignWithLabel: true
                },
                // 修改刻度标签 相关样式
        ...
        series: [
            {
                ...
                barWidth: '35%',
                //ajax获取回来的  动态发生变化
                data: [200, 300, 300, 900, 1500, 1200],
                itemStyle: {
                    // todo 修改柱子的颜色
                    barBorderRadius: 5
                }
...
(function () {
    ...
    option = {
        ...
        yAxis: [{
            ...
            data: ['Node', 'Vue', 'JavaScript', 'CSS', 'HTML']
        }, {
            type: 'category',
            axisLine: {
                show: false
...
(function () {
    ...
    option = {
        ...
        legend: {
            //todo 如果series中对象有name值那么legend不用写data
            // data: ['邮件营销', '联盟广告'],
            textStyle: {
                color: '#4c9bfd'//图例文字颜色
            },
        ...
        series: [
            {
                ...
                smooth: true,
                //todo 可以让我们的折线显示带有弧度
                data: [24, 40, 101, 134, 90, 230, 210, 120, 230, 210, 120, 150]
            },
            {
                name: '新增游客',
                type: 'line',
    ...
    //  点击a之后 根据a的索引号找到对应的yearData的相关对象
    //     console.log(yearData[$(this).index()])//2020年
...
(function () {
    ...
    var option = {
        ...
        geo: {
            ...
            itemStyle: {
                normal: {
                    areaColor: 'rgba(20,41,87,0.5)',//地图省份的背景颜色
                    borderColor: '#195BB9',
                    borderWidth: 1,
                },
                emphasis: {
